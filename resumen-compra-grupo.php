...
<body>
    ...
    <main class="contenedor">
        ...
        <ul>
        <li><p>Precio sin descuento (" . $personas . " personas): <b style='color: orange;'>" . $precioGrupo . " € </b></li>";
        ...
        if ($descuentoGrupo > 0) {
            ...
            echo "<li><p>El descuento por grupo es de: <b class='texto_orange'>" . $descuentoTotalGrupo . " €</b></p></li>";
        }

        if ($periodo >= 4) {
            $descuentoDuracion = 0.20;
            echo "<li><p>El descuento por duración es de: <b class='texto_orange'>" . ($descuentoDuracion * 100) . " %.</b></p></li>";
        } elseif ($periodo >= 2) {
        ...
        if (isset($_POST['picnic'])) {
            ...
            echo "<li><p>Servicio extra: Picnic natural: <b class='texto_orange'>" . $precioExtra . " €</b></p></li>";
        }
        ...
        if (isset($_POST['kitNatural'])) {
            ...
            $precioFinalTotal += $precioExtra;
            echo "<li><p>Servicio extra: Kit natural (" . $personas . "): <b class='texto_orange'>" . $precioExtra . " €</b></p></li>";
        }
        ...
        if (isset($_POST['transporte'])) {
            $precioExtra = 20 * $personas;
            $precioFinalTotal += $precioExtra;
            echo "<li><p>Servicio extra: Transporte (" . $personas . "): <b class='texto_orange'>" . $precioExtra . " €</b></p></li>";
        }
        ...
        if (isset($_POST['foto'])) {
            $precioExtra = 150;
            $precioFinalTotal += $precioExtra;
            echo "<li><p>Servicio extra: Sesión de fotos: <b class='texto_orange'>" . $precioExtra . " €</b></p></li>";
        }
