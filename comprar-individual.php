...
<body>
    ...
    <main>
        <div>
            ...
            <form action="resumen-compra-individual.php" method="post">
                ...
                <div>
                    <label>
                        ...
                        <p>Para enriquecer aún más tu experiencia en Tree Hugger Excursions, ofrecemos una variedad de servicios
                    ...
                    <label for="kitNatural">
                        <div class="box_calcular">
                            ...
                            <p><b>LLeva la paz contigo!</b> Nuestro <strong>Kit de bienestar natural</strong> es una forma maravillosa de continuar sintiendo los
                                beneficios de tu experiencia con Tree Hugger Excursions en casa. Este kit especial incluye aceites
